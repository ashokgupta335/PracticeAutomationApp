...
Scenario: Invalid sign in details
When I click on home and enter wrong sign in details from excel "src/test/resources/excel/AutomationPractice.xlsx" with sheetname as "InvalidSignInDetails"
